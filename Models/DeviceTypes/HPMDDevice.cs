...
{
    /// <summary>
    /// HPM-D qurilma turi konfiguratsiyasi
    /// </summary>
    public class HPMDDevice
    {
        public string Name => "HPM-D";
        public string PortName => "/dev/ttyS0"; // RS485 uchun default port
        public int BaudRate => 9600;
        public string Description => "HPM-D taroziklass qurilmasi";
        ...
        public int? ProcessWeightData(byte[] buffer)
        {
            ...
            // HPM-D protokol: buffer[0] == 0x02 && buffer[1] == 0x2B
